...
func TestDownloadLongPollWhenNotModifiedStatusDependOnDownloadObject(t *testing.T) {
	...
	if resp.longPoll != fixture.d.longPollingEnabled {
		t.Fatalf("Unexpected longPoll modification: %t, %t", fixture.server.longPoll, resp.longPoll)
	}
...
func TestOneShotLongPollingSwitch(t *testing.T) {
	...
	if fixture.d.longPollingEnabled != fixture.server.longPoll {
		t.Fatalf("Unexpected longPollingEnabled %t", fixture.d.longPollingEnabled)
	}
...
func TestOneShotNotLongPollingNoSwitch(t *testing.T) {
	ctx := context.Background()
	config := Config{}
	...
	fixture.server.opaVendorMediaTypeEnabled = true
	err := fixture.d.oneShot(ctx)
	if err != nil {
		t.Fatal("Unexpected:", err)
	}
	...
	fixture.server.opaVendorMediaTypeEnabled = false
	err = fixture.d.oneShot(ctx)
	if err != nil {
		t.Fatal("Unexpected:", err)
	}
...
func (t *testServer) handle(w http.ResponseWriter, r *http.Request) {
	...
	if (t.opaVendorMediaTypeEnabled) || (t.longPoll && !not_modified) {
